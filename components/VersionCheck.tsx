 ...
 *
 * เหตุผล: แถบเมนูอยู่ทุกหน้า ถ้าตรวจใหม่ทุกครั้งที่เปลี่ยนหน้าจะเป็นการยิงคำขอ
 * ออกอินเทอร์เน็ตทิ้งเปล่าทั้งวันโดยไม่ได้อะไรเพิ่ม หน่วยบริการหลายแห่งเน็ตช้าด้วย
 * เวอร์ชันใหม่ออกไม่กี่ครั้งต่อสัปดาห์ ไม่มีเหตุต้องรู้เร็วกว่านี้
 * (ฝั่งเซิร์ฟเวอร์ยังพักผลไว้อีก 6 ชั่วโมงซ้อนอยู่)
 */
