...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    detail:
      "เลขใบประกอบวิชาชีพ, เลขบัตรประชาชน 13 หลัก และประเภทบุคลากร (provider_type) ของเจ้าหน้าที่ทุกคนที่ยังปฏิบัติงาน ส่วนรหัสสภาวิชาชีพ (01-08) บังคับเฉพาะกลุ่มที่มีใบประกอบวิชาชีพ เช่น แพทย์ ทันตแพทย์ พยาบาล เภสัชกร",
  ...
  },
  {
    ...
    detail:
      ...
      "(ตรวจได้จากหน้าจอของ HOSxP โดยตรง ไม่มีการ์ดตรวจในโปรแกรมนี้แล้ว)",
  },
  {
    key: "drug",
  ...
  },
  {
    ...
    detail:
      "ตั้งรหัสค่าบริการ/หัตถการให้ตรง Fee Schedule ของ สปสช. ให้ครบ: HPV, คัดกรองเบาหวาน, Cholesterol+HDL, CBC 13-24 ปี, เคลือบฟลูออไรด์, Fit Test, ไวรัสตับอักเสบ, วัคซีนไข้หวัดใหญ่ (Z251) และวัคซีนอื่นๆ, ยาคุมกำเนิด, ถุงยางอนามัย — รหัสของแต่ละหน่วยบริการไม่เหมือนกัน ระบบตรวจให้อัตโนมัติไม่ได้ ต้องเทียบกับประกาศ Fee Schedule ฉบับล่าสุดเอง",
  },
  {
    key: "auth",
