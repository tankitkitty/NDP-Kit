...
**ข้อมูลที่ส่ง** — มีเพียง 2 รายการนี้เท่านั้น ตามที่ระบุไว้ในแบบฟอร์มยินยอม
...
> คอลัมน์ **ชื่อสถานพยาบาล** และ **วันเวลาที่ส่ง** ในชีตจะว่างไว้ เพราะโปรแกรม
> ไม่ส่งสองอย่างนี้แล้ว (เคยส่งในรุ่นก่อน) ส่วนคอลัมน์ **วันเวลาที่รับ** ยังมีค่าปกติ
> เพราะฝั่ง Google Sheet เป็นคนบันทึกเองตอนได้รับ — ลบสองคอลัมน์นั้นทิ้งได้ถ้าไม่ต้องการ
