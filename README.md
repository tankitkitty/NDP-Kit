...
สรุปสั้นๆ — **วิธีที่แนะนำ (สำหรับหน่วยบริการ):** เปิด PowerShell บนเครื่อง Windows ที่จะติดตั้ง แล้วรัน

```powershell
irm https://raw.githubusercontent.com/tankitkitty/NDP-Kit/master/install/ndp-kit-setup.ps1 | iex
```

ตัวช่วยจะดาวน์โหลด Node.js รุ่นพกพาและตัวโปรแกรมมาติดตั้งที่ `C:\NDP-Kit` ให้เอง
ไม่ต้องลง Node.js/Git เอง ไม่ต้องใช้สิทธิ์ผู้ดูแลระบบ และตั้งให้เปิดเองทุกครั้งที่เข้าใช้เครื่อง
อัปเดตเวอร์ชันใหม่ก็รันตัวช่วยแล้วเลือกเมนู `[1]` อีกครั้ง ค่าตั้งค่าเดิมอยู่ครบ

วิธีคัดลอกไฟล์ไปติดตั้ง และวิธีติดตั้งแบบออฟไลน์ ดูที่ [install/README.md](install/README.md)

หรือแบบรันจากซอร์สโค้ดสำหรับผู้พัฒนา (ต้องมี Node.js):
