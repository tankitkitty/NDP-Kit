...
> เพื่อไม่ให้เครื่องไหนติดค้างอยู่กับเวอร์ชันเก่าโดยไม่รู้ตัว เครื่องที่จะติดตั้งจึงต้องเข้า
> drive.google.com ได้ — ถ้าเข้าไม่ได้ ให้ขอไฟล์ `ndp-kit-offline.zip` จากผู้ดูแล
> แล้วใช้ **เมนู 6** แทน (ติดตั้งจากไฟล์ที่เตรียมมา)
