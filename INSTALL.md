...
> - โปรแกรมติดตั้งที่ `C:\NDPKit` เสมอ ค่าตั้งค่าของหน่วยบริการอยู่ที่ `C:\NDPKit\app\data` และไม่หายเวลาอัปเดต
> - ตัวช่วยตั้ง Task Scheduler ให้เปิดโปรแกรมเองทุกครั้งที่เข้าใช้เครื่อง
> - ตัวแปร NHSO_* (ปุ่มซิงค์สถานะเคลม) ตั้งผ่านไฟล์ `.env.local` ในโฟลเดอร์ `C:\NDPKit\app`
