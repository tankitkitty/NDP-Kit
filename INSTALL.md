...
ใช้ไฟล์เดียวกับวิธี ข แต่เพิ่มอีก 2 ไฟล์วางไว้ข้างกัน ตัวช่วยจะใช้ไฟล์เหล่านี้แทนการดาวน์โหลด

- `ndp-kit.zip` — ดาวน์โหลดจากหน้า [Releases](https://github.com/tankitkitty/NDP-Kit/releases/latest)
